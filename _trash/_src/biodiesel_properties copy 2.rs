use crate::{
    ...
    utils::{
        HashedDataFrame,
        polars::{format_array, format_standard_deviation},
    },
};
...
fn compute(key: Key, length: usize) -> PolarsResult<Value> {
    ...
    //     cetane_number(col(r#"^.*Array\[\d+\]$"#))
    //         .name()
    //         .replace("Array", "CetaneNumber", true),
    //     cold_filter_plugging_point(col(r#"^.*Array\[\d+\]$"#))
    //         .name()
    //         .replace("Array", "ColdFilterPluggingPoint", true),
    //     degree_of_unsaturation(col(r#"^.*Array\[\d+\]$"#))
    //         .name()
    //         .replace("Array", "DegreeOfUnsaturation", true),
    //     iodine_value(col(r#"^.*Array\[\d+\]$"#))
    //         .name()
    //         .replace("Array", "IodineValue", true),
    //     long_chain_saturated_factor(col(r#"^.*Array\[\d+\]$"#))
    //         .name()
    //         .replace("Array", "LongChainSaturatedFactor", true),
    //     oxidation_stability(col(r#"^.*Array\[\d+\]$"#))
    //         .name()
    //         .replace("Array", "OxidationStability", true),
    // ]);
    // println!(
    //     "lazy_frame PRO 2: {}",
    //     lazy_frame.clone().collect().unwrap()
    ...
    // // Concat array
    // lazy_frame = lazy_frame.select([
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS123}\.CetaneNumber\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS13}\.CetaneNumber\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS2}\.CetaneNumber\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS123}\.ColdFilterPluggingPoint\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS13}\.ColdFilterPluggingPoint\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS2}\.ColdFilterPluggingPoint\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS123}\.DegreeOfUnsaturation\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS13}\.DegreeOfUnsaturation\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS2}\.DegreeOfUnsaturation\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS123}\.IodineValue\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS13}\.IodineValue\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS2}\.IodineValue\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS123}\.LongChainSaturatedFactor\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS13}\.LongChainSaturatedFactor\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS2}\.LongChainSaturatedFactor\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS123}\.OxidationStability\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS13}\.OxidationStability\[\d+\]$"#
    //     ))])?,
    //     concat_arr(vec![col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS2}\.OxidationStability\[\d+\]$"#
    //     ))])?,
    // ]);
    // println!(
    //     "lazy_frame PRO 3: {}",
    //     lazy_frame.clone().collect().unwrap()
    // );
    // // lazy_frame = lazy_frame.select([all().as_expr().name().replace("[0]", "", true)]);
    // lazy_frame = lazy_frame.select([as_struct(vec![
    //     as_struct(vec![
    //         col(formatcp!(
    //             r#"^{STEREOSPECIFIC_NUMBERS123}\.CetaneNumber\[0\]$"#
    //         )),
    //         col(formatcp!(
    //             r#"^{STEREOSPECIFIC_NUMBERS123}\.CetaneNumber\[0\]$"#
    //         )),
    //     ]),
    //     col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS13}\.CetaneNumber\[0\]$"#
    //     )),
    //     col(formatcp!(
    //         r#"^{STEREOSPECIFIC_NUMBERS2}\.CetaneNumber\[0\]$"#
    //     )),
    // ])
    // .alias("CetaneNumber")]);
    // println!(
    ...
    //     lazy_frame.clone().collect().unwrap()
    // );
    // // lazy_frame = lazy_frame.with_columns([col("CetaneNumber").struct_().with_fields(fields)]);
