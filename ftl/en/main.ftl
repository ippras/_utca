...
Composition_Mass_Positionalspecific = Mass, positional
    .abbreviation = PMC
    .hover = Mass positional-specific composition (agregation).
Composition_Mass_Stereospecific = Mass, stereo
    .abbreviation = SMC
    .hover = Mass stereospecific composition.
Composition_EquivalentCarbonNumber_Positionalspecific = ECN, positional
    .abbreviation = MNC
    .hover = Equivalent carbon number positional-specific composition (agregation).
...
Composition_Unsaturation_Positionalspecific = Unsaturation, positional
    .abbreviation = PUC
    .hover = Unsaturation positional-specific composition (agregation).
